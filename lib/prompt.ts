...
- Do NOT claim the fare is "the cheapest" — it may be a fewer-stops option chosen for value over the rock-bottom fare. Describe it as the round-trip fare for the trip; the tool's note tells you whether it was selected for fewer stops, and the plan's flight card shows the traveler how it compares to the cheapest.
